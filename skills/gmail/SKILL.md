...
- Subject and body: tool transliterates non-ASCII (em-dash → `--`, smart quotes → straight) for max portability. Pass `--keep-utf8` if you specifically want RFC-2047 subject + 8bit body.
